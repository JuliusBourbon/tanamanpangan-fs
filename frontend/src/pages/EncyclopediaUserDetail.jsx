...
export default function EncyclopediaUserDetail() {
  ...
  if (error || !disease) {
    return (
      <div className="w-full">
        <Link to="/encyclopedia-app" className="inline-flex items-center gap-2 text-sm font-medium hover:text-[#1E6436] mb-6 transition-colors">
  ...
  return (
    <div className="flex flex-col w-full pb-10">
      {/* Tombol Back */}
      <Link to="/encyclopedia-app" className="inline-flex items-center gap-2 text-sm font-semibold hover:text-[#1E6436] mb-6 transition-colors w-fit px-4 py-2 borderrounded-lg">
        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 19l-7-7m0 0l7-7m-7 7h18" /></svg>
      </Link>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1">
          <div className="bg-gray-100 rounded-2xl overflow-hidden aspect-square border border-gray-200 shadow-sm sticky top-6">
            <img 

...
function SocialIcon({ label, href, icon }) {
  return (
    <a href={href} aria-label={label} className="text-gray-400 hover:text-[#2a7a53] transition-colors">
      {icon}
    </a>
  )
}
...
function MemberSocials({ instagram, linkedin, github }) {
  return (
    <div className="flex items-center gap-3 mt-3">
      <SocialIcon label="Instagram" href={instagram} icon={
      ...
      <SocialIcon label="LinkedIn" href={linkedin} icon={
        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
          <path d="M16 8a6 6 0 016 6v7h-4v-7a2 2 0 00-2-2 2 2 0 00-2 2v7h-4v-7a6 6 0 016-6zM2 9h4v12H2z" />
          <circle cx="4" cy="4" r="2" />
        </svg>
      } />
      <SocialIcon label="GitHub" href={github} icon={
        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
...
export default function AboutUs() {
  ...
  return (
    <div className="font-sans text-gray-800">
      ...
      {/* Section 1: Hero dengan background image */}
      ...
      {/* Section 2: Capstone Project Story */}
      ...
      {/* Section 3: Meet The Capstone Team */}
